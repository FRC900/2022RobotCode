#ifndef _ROS_SERVICE_ImuZeroAngle_h
#define _ROS_SERVICE_ImuZeroAngle_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char IMUZEROANGLE[] = "imu_zero/ImuZeroAngle";

  class ImuZeroAngleRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return IMUZEROANGLE; };
    virtual const char * getMD5() override { return "4edb55038e2b888976a0c0c56935341c"; };

  };

  class ImuZeroAngleResponse : public ros::Msg
  {
    public:

    ImuZeroAngleResponse()
    {
    }
