#ifndef _ROS_field_obj_TFDetection_h
#define _ROS_field_obj_TFDetection_h
...
namespace field_obj
{
  ...
  class TFDetection : public ros::Msg
  {
    public:
      typedef std_msgs::Header _header_type;
      _header_type header;
      uint32_t objects_length;
      typedef field_obj::TFObject _objects_type;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(objects_lengthT > objects_length)
        this->objects = (field_obj::TFObject*)realloc(this->objects, objects_lengthT * sizeof(field_obj::TFObject));
      objects_length = objects_lengthT;
      for( uint32_t i = 0; i < objects_length; i++){
      offset += this->st_objects.deserialize(inbuffer + offset);
        memcpy( &(this->objects[i]), &(this->st_objects), sizeof(field_obj::TFObject));
      }
     return offset;
    }

    virtual const char * getType() override { return "field_obj/TFDetection"; };
    virtual const char * getMD5() override { return "f98c9a89dd1446a225b5f24d58572217"; };
