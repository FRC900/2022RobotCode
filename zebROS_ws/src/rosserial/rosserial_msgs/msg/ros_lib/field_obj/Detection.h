#ifndef _ROS_field_obj_Detection_h
#define _ROS_field_obj_Detection_h
...
namespace field_obj
{
  ...
  class Detection : public ros::Msg
  {
    public:
      ...
      typedef field_obj::Object _objects_type;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(objects_lengthT > objects_length)
        this->objects = (field_obj::Object*)realloc(this->objects, objects_lengthT * sizeof(field_obj::Object));
      objects_length = objects_lengthT;
      for( uint32_t i = 0; i < objects_length; i++){
      offset += this->st_objects.deserialize(inbuffer + offset);
        memcpy( &(this->objects[i]), &(this->st_objects), sizeof(field_obj::Object));
      }
     return offset;
    }

    virtual const char * getType() override { return "field_obj/Detection"; };
    virtual const char * getMD5() override { return "c15ee7850975abdb3abcaddb296c7330"; };
